...
public class headController implements Initializable {
    ...
    {
        colNumSite1.setCellValueFactory(new PropertyValueFactory<Employee,String>("password"));
        colNameSite1.setCellValueFactory(new PropertyValueFactory<Employee,String>("firstName"));
