...
public class HomeIntenDirectorController implements Initializable {
    ...
    private void initStudentList() {
        Identifier.setCellValueFactory(new PropertyValueFactory<Student,String>("ident"));
        email.setCellValueFactory(new PropertyValueFactory<Student,String>("professionalEmail"));
        colClass.setCellValueFactory(new PropertyValueFactory<Student,String>("classe"));
        credit.setCellValueFactory(new PropertyValueFactory<Student,String>("credit"));
    }
