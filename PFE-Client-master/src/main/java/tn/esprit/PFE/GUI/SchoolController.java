...
//        obsDepartement.clear();
    ...
    private void initSite() {
        ...
        colNumSite.setCellValueFactory(new PropertyValueFactory<Site,String>("site_id"));
        colNameSite.setCellValueFactory(new PropertyValueFactory<Site,String>("name"));
    }
    ...
    private void initDepartement() {
        ...
        col_numDep.setCellValueFactory(new PropertyValueFactory<Departement,String>("departement_id"));
        colDepName.setCellValueFactory(new PropertyValueFactory<Departement,String>("department_name"));
        colHeadDep.setCellValueFactory(new PropertyValueFactory<Employee,String>("chef.email"));
    }
    ...
    private void initOptions() {
        ...
        colNumOpt.setCellValueFactory(new PropertyValueFactory<Opt,String>("opt_id"));
        colOptName.setCellValueFactory(new PropertyValueFactory<Opt,String>("name"));
    }
    ...
    private void initEmployee() {
        ...
        colId.setCellValueFactory(new PropertyValueFactory<Employee,String>("password"));
        colEmpName.setCellValueFactory(new PropertyValueFactory<Employee,String>("firstName"));
        colLNameEmp.setCellValueFactory(new PropertyValueFactory<Employee,String>("lastName"));
...
//        colClassId.setCellValueFactory(new PropertyValueFactory<>("class_id"));
        colClassName.setCellValueFactory(new PropertyValueFactory<Classe,String>("name"));
    }
