...
public class Csvontroller implements Initializable {
    ...
    private void initData() {
        //password
        colId.setCellValueFactory(new PropertyValueFactory<Student,String>("ident"));
        colName.setCellValueFactory(new PropertyValueFactory<Student,String>("firstName"));
        colLast.setCellValueFactory(new PropertyValueFactory<Student,String>("lastName"));
        ...
        colClasse.setCellValueFactory(new PropertyValueFactory<Classe,String>("classe"));
    }
